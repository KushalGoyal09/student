...
export const HonestWeekPicker = ({ onChange }: WeekPickerProps) => {
    ...
    const handleClick = (e: MouseEvent<HTMLDivElement>) => {
        ...
        if (target.id.includes("prev")) {
            ...
            localDate = new Date(date.setDate(Number(target.id)));
            setDate(new Date(date.setDate(Number(target.id))));
        }

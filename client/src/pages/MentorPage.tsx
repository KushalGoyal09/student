...
export default function MentorPage() {
    return (
        <>
            <div className="w-full h-full flex items-center justify-center bg-pcb/30">
                <div className="p-6 rounded-lg shadow-lg max-w-md w-full">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-blue-600 rounded-lg p-4">
                            <span className="block bg-blue-700 text-white text-xl font-bold py-3 px-4 rounded-lg mb-4 text-center">
                                <span className="flex items-center justify-center">
                        ...
                        <div className="bg-black/80 rounded-lg p-4">
                            <span className="block bg-black text-white text-xl font-bold py-3 px-4 rounded-lg mb-4 text-center">
                                OTHER MEMBERS
                            </span>

...
export function EditPaymentDialog({ payment, onClose, onSave }: EditPaymentDialogProps) {
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              onChange={(e) => setEditedPayment({ ...editedPayment, amount: parseInt(e.target.value) })}
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              onChange={(e) => setEditedPayment({ ...editedPayment, mode: e.target.value })}
              className="col-span-3"
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => setEditedPayment({ ...editedPayment, cleared: checked })}
            />
          </div>
        </div>

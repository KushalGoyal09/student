...
export function FeeStructureForm({
    ...
    const [mentorshipPlan, setMentorshipPlan] = useState<MentorshipPlan>(
        initialData?.mentorshipPlan || "Elite",
    );
    ...
    useEffect(() => {
        if (!initialData) {
            ...
            const defaultPayments = defaultFeeStructure[mentorshipPlan][
                ...
                id: `payment-${index + 1}`,
                amount,
                date: new Date(Date.now() + index * 45 * 24 * 60 * 60 * 1000)
                    .toISOString()
                    .split("T")[0],
                mode: null,
                cleared: false,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                >
                    ...
                    <SelectContent>
                        {Object.keys(defaultFeeStructure[mentorshipPlan]).map(
                            (plan) => (
                    ...
                    <div key={payment.id} className="flex space-x-2">
                        <Input
                            ...
                            onChange={(e) => {
                                ...
                                newPayments[index].amount = parseInt(
                                    e.target.value,
                                );
